...
namespace Cmn
{
    class PlayerInfo {
        ...
        _BYTE field_14;
        _BYTE field_15;
        __attribute__((aligned(1))) char16_t *name;
        _BYTE gap1E[26];
        __int64 modelType;
        __int32 hairId;
        __int32 skinColor;
        __int32 eyeColor;
        __attribute__((aligned(1))) Cmn::Def::Weapon weapon;
        _WORD word5C;
        _BYTE gap5E[6];
        Cmn::Def::Gear gear[3];
        __int32 tankId;
        ...
        Cmn::Def::MMR mmr2;
        _BYTE gap120[4];
        __attribute__((aligned(1))) _QWORD qword124;
        __attribute__((aligned(1))) _QWORD qword12C;
        _BYTE gap134[28];
        _DWORD dword150;
